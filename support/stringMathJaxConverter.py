...
def convertMathjax(string):                             # pragma: no cover
    ...
    if path.exists("static/results/MathJaxResult.txt"):        # pragma: no cover
        os.remove("static/results/MathJaxResult.txt")          # pragma: no cover
    f = open("static/results/MathJaxResult.txt", "w")          # pragma: no cover
