...
from support import stringCalculation, stringMathJaxConverter, generateStrForLatexAndTree
# from handwritten_math_expression
from support import ImagePreprocessing as ip
...
def write_labels_for_all_segs(filepath):
  model = load_model('D:\Programs\Final_year_project\Project_V1\support\LeNetModel_v3.h5')
  label_map = 'D:\Programs\Final_year_project\Project_V1\support\label_map_v3.npy'
  label = []
  positions = []
...
def my_func():
    labels = []
    positions = []
    image_inputpath = 'static/uploads/*.png'
    segimg_savepath = 'static/uploads'
