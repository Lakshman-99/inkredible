...
def writeCalResult(expression):                                     # pragma: no cover
    ...
    if path.exists("static/results/calculationResult.txt"):                # pragma: no cover
        os.remove("static/results/calculationResult.txt")                  # pragma: no cover
    f = open("static/results/calculationResult.txt", "w")                  # pragma: no cover
